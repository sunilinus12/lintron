...
export function setupXhrInterceptor(client: any): void {
  if (isXhrInterceptorActive) return;
  ...
  class LintronXHR extends OriginalXHR {
    ...
    send(body?: any): void {
      ...
      const profile = networkEngine.getProfile();
